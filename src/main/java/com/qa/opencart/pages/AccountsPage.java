...
public class AccountsPage {
	...
	public List<String> getAccPageHeaders(){
		List<WebElement> heardersList = eleUtil.waitForElementsPresence(headers, AppConstants.DEFAULT_SHORT_WAIT);
		System.out.println("Total no. of headers:"+heardersList.size());
		List<String> accPageHeadersList = new ArrayList<String>();
		for(WebElement e : heardersList) {
			String headersVal = e.getText();
			accPageHeadersList.add(headersVal);
		}
